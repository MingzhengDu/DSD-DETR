...
class DETRHead(AnchorFreeHead):
    ...
    def _get_mid_target_single(self,
                           cls_score,
                           bbox_pred,
                           gt_bboxes,
                           gt_labels,
    ...
    def forward_train(self,
        ...
        losses = self.loss(*loss_inputs, all_pseudo_boxes, remapping_gt_labels, idxs, full_category_embeddings, base_category_embeddings, gt_bboxes_ignore=gt_bboxes_ignore)
        return losses
    ...
    def _get_bboxes_single(self,
        ...
        if self.loss_cls.use_sigmoid:
            ...
            # scores, indexes = cls_score.contiguous().view(-1).topk(max_per_img)
